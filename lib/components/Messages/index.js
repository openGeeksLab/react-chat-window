    ...
    switch (type) {
      case 'text':
        return _react2.default.createElement(
          'div',
          null,
          this.props.message.showText && _react2.default.createElement(_SystemMessage2.default, this.props.message.showText),
          _react2.default.createElement(_TextMessage2.default, this.props.message)
        );
      case 'emoji':
  ...
  Message.prototype.render = function render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        message.type !== _constants.SYSTEM && _react2.default.createElement('div', { className: 'sc-message--avatar', style: {
            backgroundImage: 'url(' + (recipientAvatar || _chatIcon2.default) + ')'
          } }),
